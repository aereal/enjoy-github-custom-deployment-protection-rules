module github.com/aereal/enjoy-github-custom-deployment-protection-rules

go 1.20

require (
	github.com/aereal/otel-propagators/datadog v0.2.0
	github.com/aereal/paramsenc v0.1.2
